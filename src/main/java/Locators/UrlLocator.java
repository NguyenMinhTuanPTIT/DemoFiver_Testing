...
public class UrlLocator {
    public static final String LOGIN_URL ="https://demo5.cybersoft.edu.vn/login";
    public static final String registerPageUrl ="https://demo5.cybersoft.edu.vn/register";
